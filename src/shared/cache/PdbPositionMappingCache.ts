...
export async function fetchPdbPositionMappingData(
	positions: number[],
	alignmentIds: number[],
...
async function fetch(
	queries: AlignmentIdAndUniportPos[]
): Promise<PdbUniprotResidueMapping[]> {
...
export default class PdbPositionMappingCache extends LazyMobXCache<
	PdbUniprotResidueMapping,
	AlignmentIdAndUniportPos
> {
	constructor() {
		super(
