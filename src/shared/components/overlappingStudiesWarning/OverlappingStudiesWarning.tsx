		...
		if (overlapping.length > 0) {
			return (
				<div className="alert alert-danger" style={{ marginBottom: 0 }}>
					<i className="fa fa-exclamation-triangle" /> You have selected multiple TCGA studies with
					overlapping samples, highlighted in red below. Please limit your selection to one TCGA study per
					cancer type.
				</div>
			);
		} else {
