	...
	private static getCohortFrequencyTooltip(variantCount: AugVariantCountOutput | null) {
		...
		if (variantCount === null) {
			...
			return (
				<div>
					<span>
						{variantCount.data.numberOfSamplesWithMutationInGene} samples ({CohortColumnFormatter.getBoldPercentage(
							variantCount.data.numberOfSamplesWithMutationInGene / variantCount.data.numberOfSamples
						)}) in this study have mutated {variantCount.hugoGeneSymbol}
						{typeof variantCount.data.keyword !== "undefined" && (
							<span>
								, out of which {variantCount.data.numberOfSamplesWithKeyword} ({CohortColumnFormatter.getBoldPercentage(
									variantCount.data.numberOfSamplesWithKeyword! / variantCount.data.numberOfSamples
