				...
				<div className="rightBarSection">
					...
					<div
						dangerouslySetInnerHTML={{
							__html: AppConfig.skinRightNavWhatsNewBlurb
						}}
					/>;
				</div>
			);
