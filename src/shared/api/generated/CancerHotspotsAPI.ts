...
export default class CancerHotspotsAPI {
	...
	fetchMetadataURL(parameters: { $queryParameters?: any }): string {
		let queryParameters: any = {};
	...
	fetchMetadata_1URL(parameters: { $queryParameters?: any }): string {
		let queryParameters: any = {};
		let path = "/api/metadata";
	...
	fetchAllVariantsGETURL(parameters: { $queryParameters?: any }): string {
		let queryParameters: any = {};
	...
	fetchVariantsGET(parameters: {
		...
		return new Promise(function(resolve, reject) {
			...
			if (parameters["aminoAcidChanges"] === undefined) {
				reject(
					new Error("Missing required  parameter: aminoAcidChanges")
				);
				return;
			}
