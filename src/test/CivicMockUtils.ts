	...
	return {
		RAF1: {
			AMPLIFICATION: {
				...
				description: "",
				url:
					"https://civic.genome.wustl.edu/#/events/genes/4767/summary/variants/591/summary#variant",
	...
	return {
		PIK3CA: {
			E545K: {
				...
				url:
					"https://civic.genome.wustl.edu/#/events/genes/37/summary/variants/104/summary#variant",
