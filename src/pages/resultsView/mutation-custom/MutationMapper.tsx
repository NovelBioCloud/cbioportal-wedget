...
import StructureViewerPanel from "../../../shared/components/structureViewer-custom/StructureViewerPanel";
...
import LollipopMutationPlot from "../../../shared/components/lollipopMutationPlot-custom/LollipopMutationPlot";
import ProteinImpactTypePanel from "../../../shared/components/mutationTypePanel/ProteinImpactTypePanel";
import ProteinChainPanel from "../../../shared/components/proteinChainPanel-custom/ProteinChainPanel";
...
export default class MutationMapper extends React.Component<IMutationMapperProps, {}> {
	...
	constructor(props: IMutationMapperProps) {
		...
		this.handlers = {
			...
			onXAxisOffset: action((offset: number) => {
